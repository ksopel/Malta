...
function Blurb() {
    return (
        <section className="container-fluid bg-light">
            <div className="content__blurb container">
                <div className="d-flex flex-wrap row ">
                    <div className="blurb col mt-3" style={blurbStyle}>
                        ...
                        <p className="text-center text-muted">Animi commodi ea, error explicabo obcaecati porro suscipit. Animi eaque facilis fuga illo
